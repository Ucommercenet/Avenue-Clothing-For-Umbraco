...
del package\uCommerce_Demo_Store_-_Razor_3.0.0.0 /Q
del package\_ToPackage /Q
del package /Q
rd package\uCommerce_Demo_Store_-_Razor_3.0.0.0\61fc5d84-9cc2-4d36-93a8-bfe0d076b219 /Q
rd package\uCommerce_Demo_Store_-_Razor_3.0.0.0 /Q
rd package /Q

rem Create the package directory
rem md package\uCommerce_Demo_Store_-_Razor_3.0.0.0\61fc5d84-9cc2-4d36-93a8-bfe0d076b219
...
robocopy src\uCommerce.RazorStore package\_ToPackage\files uCommerceApiRegistration.cs FacetedQueryStringExtensions.cs *.cshtml *.js *.png *.jpg *.jpeg *.gif /s /FFT /Z /XA:H /W:5
...
tools\deploy\PackageGen.exe -name="package\uCommerce_Demo_Store_-_Razor_3.0.0.0.zip" -guid="61fc5d84-9cc2-4d36-93a8-bfe0d076b219" -path="package\_ToPackage" -control="/umbraco/ucommerce/install/DemoStoreInstaller.ascx"
