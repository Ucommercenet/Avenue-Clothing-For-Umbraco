    ...
    public class CatalogueInstaller
    {
        ...
        private EmailProfile GetDefaultEmailProfile()
        {
            ...
            if (emailProfile == null)
                throw new ArgumentOutOfRangeException("emailProfile",
                    "The Default email profile could not be found. Have you run the installer?");
        ...
        private OrderNumberSerie GetDefaultOrderNumberSeries()
        {
            ...
            if (orderNumberSeries == null)
                throw new ArgumentOutOfRangeException("orderNumberSeries",
                    "The Example order number series could not be found. Have you run the installer?");
        ...
        private void CreateCasualShirts(Category shirts, ProductDefinition shirtDefinition)
        {
            ...
            var prettyGreen = CreateProductOnCategory(casual, shirtDefinition, "GHXG-4044-7604-1",
                "Pretty Green White Pinstripe Jersey Short Sleeve Polo Shirt", 65, "",
                "<ul><li>Three button placket and classic polo collar</li><li>Short sleeved</li><li>Signature embroidered Pretty Green chest badge</li><li>White and black pin stripe</li><li>100% jersey cotton</li><li>Style number : GHXG/4044/7604/1</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/polo-shirts-7/pretty-green-white-pinstripe-jersey-short-19759.htm\">Pritchards.co.uk</a></p>");
            AddShirtVariantsToProduct(prettyGreen, "Striped", new List<string>() {"SML", "MED", "LAR", "X.L"},
        ...
        private void CreateFormalShirts(Category shirts, ProductDefinition shirtDefinition)
        {
            ...
            var smDesc =
                "<p>100% high quality cotton fabric from Austria &amp; Italy</p> <p>European made</p> <p>Unique and exclusive patterns - on the inside of the collar, placket and cuffs</p> <p>Non-iron fabric</p> <p>Machine washable to 40<span>°</span>&nbsp;C</p> <p>Slim cut tapered shirt</p> <p>Cuffs close with or without cufflinks</p> <p>Permanent collar stays</p> <p>Versatility - smart for the office and exclusive for after work</p>";

            var wonderland = CreateProductOnCategory(formal, shirtDefinition, "BWWMSFSS-LE",
                "Black & White Wonderland Mood Slim Fit Signature Shirt - Limited Edition [200 pieces]", 219, "",
                smDesc +
                "<p>As featured on <a href=\"https://stauntonmoods.com/shop/all-moods/black--white-wonderland-mood-slim-fit-signature-shirt---limited-edition-%5b200-pieces%5d/c-23/c-85/p-235\">stauntonmoods.com</a></p>");
            AddShirtVariantsToProduct(wonderland, "Plain", new List<string>() {"15", "16", "17", "18"},
                new List<string>() {"White"});
            AddProductProperty(wonderland, "ShowOnHomepage", "true");
            wonderland.Save();

            var kittens = CreateProductOnCategory(formal, shirtDefinition, "BKMSFSS",
                "Blue Kittens Mood Slim Fit Signature Shirt", 179, "",
                smDesc +
                "<p>As featured on <a href=\"https://stauntonmoods.com/shop/all-moods/blue-kittens-mood-slim-fit-signature-shirt/c-23/c-85/p-119\">stauntonmoods.com</a></p>");
            AddShirtVariantsToProduct(kittens, "Plain", new List<string>() {"15", "16", "17", "18"},
                new List<string>() {"White", "Blue"});

            var pink = CreateProductOnCategory(formal, shirtDefinition, "PMMSFSS-LE",
                "Pink Manga Mood Slim Fit Signature Shirt - Limited Edition [100 pieces]", 279, "",
                smDesc +
                "<p>As featured on <a href=\"https://stauntonmoods.com/shop/all-moods/pink-manga-mood-slim-fit-signature-shirt---limited-edition-%5b100-pieces%5d/c-23/c-85/p-156\">stauntonmoods.com</a></p>");
            AddShirtVariantsToProduct(pink, "Plain", new List<string>() {"15", "16", "17", "18"},
                new List<string>() {"White", "Blue"});

            var jungle = CreateProductOnCategory(formal, shirtDefinition, "JNMSFSS",
                "Jungle by Night Mood Slim Fit Signature Shirt", 179, "",
                smDesc +
                "<p>As featured on <a href=\"https://stauntonmoods.com/shop/all-moods/jungle-by-night-mood-slim-fit-signature-shirt/c-23/c-85/p-125\">stauntonmoods.com</a></p>");
            AddShirtVariantsToProduct(jungle, "Plain", new List<string>() {"15", "16", "17", "18"},
                new List<string>() {"White", "Blue"});

            var ghoulies = CreateProductOnCategory(formal, shirtDefinition, "GGMSFSS-LE",
                "Green Ghoulies Mood Slim Fit Signature Shirt - Limited Edition [200 pieces]", 219, "",
                smDesc +
                "<p>As featured on <a href=\"https://stauntonmoods.com/shop/all-moods/green-ghoulies-mood-slim-fit-signature-shirt---limited-edition-%5b200-pieces%5d/c-23/c-85/p-124\">stauntonmoods.com</a></p>");
            AddShirtVariantsToProduct(ghoulies, "Plain", new List<string>() {"15", "16", "17", "18"},
                new List<string>() {"White", "Blue"});

            var comic = CreateProductOnCategory(formal, shirtDefinition, "CMSFSS",
                "Comic Mood Slim Fit Signature Shirt", 179, "",
                smDesc +
                "<p>As featured on <a href=\"https:///shop/all-moods/comic-mood-slim-fit-signature-shirt/c-23/c-85/p-151\">stauntonmoods.com</a></p>");
            AddShirtVariantsToProduct(comic, "Plain", new List<string>() {"15", "16", "17", "18"},
                new List<string>() {"White", "Blue"});

            var eton = CreateProductOnCategory(formal, shirtDefinition, "2285794682539",
                "Eton Purple & White Stripe Contemporary Fit Formal Dress Shirt", 135, "",
                "<ul><li>Contemporary Fit</li><li>Single button cuffs with double button holes for cuff links</li><li>Pointed collar with bone inserts</li><li>Purple and white stipe</li><li>100% cotton</li><li>Style number : 2285794682539</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/shirts-6/eton-purple-white-stripe-contemporary-formal-20625.htm\">Pritchards.co.uk</a></p>");
            AddShirtVariantsToProduct(eton, "Striped", new List<string>() {"15", "15.5", "16", "16.5"},
                new List<string>() {"White"});
            AddProductProperty(eton, "ShowOnHomepage", "true");
            eton.Save();

            var rlA02 = CreateProductOnCategory(formal, shirtDefinition, "A02 WCJNK C0223 C421A",
                "Polo Ralph Lauren Blue & White Stripe Custom Fit Regent Poplin Dress Shirt", 85, "",
                "<ul><li>Custom fit dress shirt</li><li>Classic single button collar</li><li>Long sleeve with single button cuff</li><li>Blue and white stripe with newport navy polo player</li><li>100% poplin cotton</li><li>Style number : A02 WCJNK C0223 C421A</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/shirts-6/polo-ralph-lauren-blue-white-stripe-18999.htm\">Pritchards.co.uk</a></p>");
            AddShirtVariantsToProduct(rlA02, "Striped", new List<string>() {"SML", "MED", "LAR", "X.L", "XXL", "XXXL"},
                new List<string>() {"Blue"});

            var rlA04 = CreateProductOnCategory(formal, shirtDefinition, "A04 WCBPS C4572 G4562",
                "Polo Ralph Lauren Blue & Navy Stripe Custom Fit Broadcloth Long Sleeve Shirt", 105, "",
                "<ul><li>Custom Fit</li><li>Classic button down collar</li><li>Long sleeve with single button cuff</li><li>Blue, navy and white stripes</li><li>100% cotton</li><li>Style number : A04 WCBPS C4572 G4562</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/shirts-6/polo-ralph-lauren-blue-navy-stripe-18980.htm\">Pritchards.co.uk</a></p>");
            AddShirtVariantsToProduct(rlA04, "Striped", new List<string>() {"SML", "MED", "LAR", "X.L", "XXL"},
                new List<string>() {"Blue"});
        }
        ...
        private void CreateAccessories(ProductCatalog catalog)
        {
            ...
            CreateProductOnCategory(accessories, accessoryDefinition, "LBAT", "Luxury Baby Alpaca Throw", 125, "",
                "<ul><li>100% Baby Alpaca Wool</li><li>180cm x 130cm (plus tassel fringe)</li><li>Fair Trade</li><li>Hypo-allergenic</li></ul><p>As featured on <a href=\"http://www.amazon.co.uk/Luxury-Threads-100%25-Alpaca-Throw/dp/B008WMLGCO/ref=sr_1_5?s=kitchen&ie=UTF8&qid=1349966612&sr=1-5\">Luxury Threads</a></p>");
        ...
        private void CreateScarves(Category accessories, ProductDefinition accessoryDefinition)
        {
            ...
            CreateProductOnCategory(scarves, accessoryDefinition, "LBAS", "Luxury Baby Alpaca Scarf", 99, "",
                "<ul><li>100% Baby Alpaca Wool</li><li>180cm x 130cm (plus tassel fringe)</li><li>Fair Trade</li><li>Hypo-allergenic</li></ul><p>As featured on <a href=\"http://www.amazon.co.uk/Luxury-Threads-100%25-Alpaca-Throw/dp/B008WMLGCO/ref=sr_1_5?s=kitchen&ie=UTF8&qid=1349966612&sr=1-5\">Luxury Threads</a></p>");
            CreateProductOnCategory(scarves, accessoryDefinition, "20178",
                "Hugo Boss Black Frando Multi Colour Square Check Pattern Wool Scarf", 55, "",
                "<ul><li>Embroidered Hugo Boss Logo</li><li>Tassled Ends</li><li>Size 180 cm x 29 cm (including tassels)</li><li>Multi Colour Square Check Pattern</li><li>100% Virgin Wool</li><li>Style Number : 50230552 10159101 01 641</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/scarves-32/hugo-boss-black-frando-multi-colour-20178.htm\">Pritchards.co.uk</a></p>");
            CreateProductOnCategory(scarves, accessoryDefinition, "20180",
                "Hugo Boss Black Farion Multi Colour Stripe ", 55, "",
        ...
        private void CreateTies(Category accessories, ProductDefinition accessoryDefinition)
        {
            ...
            CreateProductOnCategory(ties, accessoryDefinition, "19849",
                "Paul Smith Accessories Classic Blue with Brown & Pink Stripe Silk Woven Tie", 69.50M, "",
            ...
            CreateProductOnCategory(ties, accessoryDefinition, "19324",
                "Hugo Boss Black Dark Red Ultra Slim Knitted Tie", 65, "",
                "<ul><li>Ultra slim knitted tie</li><li>Length: 145 cm </li><li> Width: 5 cm</li><li>Squared end</li><li>100% High-quality wool</li><li>Style Number : 5023476 10156986 01 504</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/ties-25/hugo-boss-black-burgundy-ultra-slim-19324.htm\">Pritchards.co.uk</a></p>");
            CreateProductOnCategory(ties, accessoryDefinition, "20301",
                "Hugo Boss Black Pink & White Flower Pattern Silk Woven Tie", 65, "Silky soft tie from Hugo Boss",
                "<ul><li>Flower Pattern Silk Tie</li><li>Tie Length : 145cm</li><li>Blade Width : 7.5cm</li><li>Black With Pink &amp; White Flowers</li><li>100% Silk (Made in Italy)</li><li>Style Number : 50227733 10156957 01 001</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/ties-25/hugo-boss-black-pink-white-flower-20301.htm\">Pritchards.co.uk</a></p>");
        }
        ...
        private static ProductDefinition GetProductDefinition(string name)
        {
            ...
            if (definition == null)
                throw new ArgumentOutOfRangeException("definition",
                    string.Format(
                        "No product definition with the name \"{0}\" could be found. Please check you have installed the default settings.",
                        name));

            return definition;
        }

        private void AddShirtVariantsToProduct(Product product, string namePrefix, IList<string> sizes,
            IList<string> colours)
        {
            if (!sizes.Any())
                return;
        ...
        {
            var field = ProductDefinitionField.SingleOrDefault(d =>
                product.ProductDefinition.Name == d.ProductDefinition.Name && d.Name == name);

            if (field == null)
                throw new ArgumentOutOfRangeException("field",
                    string.Format(
                        "No product definition field with the name \"{0}\" could be found. Please check you have installed the default settings.",
                        name));
        ...
        {
            var price = new Price()
                {Amount = amount, Guid = Guid.NewGuid(), PriceGroup = category.ProductCatalog.PriceGroup};
        ...
        private Product CreateBaseProduct(ProductDefinition productDefinition, string sku, string variantSku,
            string name)
        {
            if (sku.Length > 30)
